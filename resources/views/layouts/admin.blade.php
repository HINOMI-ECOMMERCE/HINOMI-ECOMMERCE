                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="images/logo/hinomi.png"
                                        data-light="images/logo/hinomi.png" data-dark="images/logo/hinomi.png"
                                        data-width="154px" data-height="52px" data-retina="images/logo/hinomi.png">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
