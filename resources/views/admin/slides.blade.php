                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-wrap">{{$slide->tagline}}</td>
                            <td class="text-wrap">{{$slide->title}}</td>
                            <td class="text-wrap">{{$slide->subtitle}}</td>
                            <td class="text-wrap">{{$slide->link}}</td>
                            <td>
...
<style>
    .table td.text-wrap {
        max-width: 200px; /* kamu bisa ubah sesuai kebutuhan */
