                ...
                <div class="wg-box">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image mb-16">
                            ...
                            {{-- Preview baru akan ditambahkan di sini lewat JS --}}
                            <div id="galUploadPreview" class="d-flex flex-wrap mb-2"></div>

                            {{-- Gambar-gambar lama (jika ada) --}}
                            @if($product->images)
...
<script>
    $(document).ready(function () {
        ...
        $('#myFile').on("change", function () {
            ...
            if (file) {
                ...
                if (preview.length) {
                    ...
                    $("#imgpreview").html(`
                        <div class="item">
                            <img src="${objectURL}" alt="Main Preview" class="effect8">
                        </div>
                    `);
                }
        ...
        $('#gFile').on("change", function () {
            ...
            const oldGallery = $("#oldGalleryPreview");
            ...
            if (files.length > 0) {
                Array.from(files).forEach(file => {
                    ...
                    const imgElement = `
                        <div class="item gitems">
                            <img src="${objectURL}" alt="Gallery Preview" class="effect8">
                        </div>
                    `;
        ...
        // Fungsi pembuat slug dari nama produk
        function generateSlug(text) {
            return text
                .toLowerCase()
                .replace(/[\s\W-]+/g, '-')   // Ubah spasi dan karakter non-alphanum jadi -
