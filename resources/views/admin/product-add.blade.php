                ...
                <div class="wg-box">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image mb-16">
                            ...
                            <div id="galUploadBtn" class="item up-load">
                            ...
                            <!-- Tempat preview galeri -->
                            <div id="galUploadPreview" class="flex flex-wrap gap-2 mt-2"></div>
                        </div>
                    </fieldset>
    ...
    $(document).ready(function () {
        ...
        $('#myFile').on("change", function () {
            ...
            if (file) {
                ...
                const imgElement = `
                    <div class="item">
                        <img src="${objectURL}" alt="Main Image Preview" class="effect8" style="max-width: 150px; margin: 5px;">
                    </div>
                `;

                previewContainer.html(imgElement).show();
            }
        });
        ...
        $('#gFile').on("change", function () {
            ...
            const previewContainer = $("#galUploadPreview");

            previewContainer.empty(); // Hapus preview lama
                ...
                Array.from(files).forEach(file => {
                    ...
                    const imgElement = `
                        <div class="item gitems">
                            <img src="${objectURL}" alt="Gallery Preview" class="effect8" style="max-width: 120px; margin: 5px;">
                        </div>
                    `;
        ...
        function generateSlug(text) {
            return text
                .toLowerCase()
                .replace(/[\s\W-]+/g, '-') // ubah spasi & simbol ke strip
